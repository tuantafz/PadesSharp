    ...
    public class OcspClientBouncyCastle : IOcspClient {
        ...
        */
        private static OcspReq GenerateOCSPRequest(X509Certificate issuerCert, BigInteger serialNumber) {
            ...
            var oids = new System.Collections.Generic.List<DerObjectIdentifier>();
            var values = new System.Collections.Generic.Dictionary<DerObjectIdentifier, X509Extension>();
            
            oids.Add(OcspObjectIdentifiers.PkixOcspNonce);
            values.Add(OcspObjectIdentifiers.PkixOcspNonce, new X509Extension(false, new DerOctetString(new DerOctetString(PdfEncryption.CreateDocumentId()).GetEncoded())));
